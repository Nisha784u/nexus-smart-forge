...
// Seed/demo dataset. Used as the initial workspace content until the signed-in
// user's own workspace data is loaded from the database.
export const members: Member[] = [
  ...
  { id: "u3", name: "Ananya", role: "Frontend Engineer", initials: "A", color: "var(--cyan)", email: "ananya@nexusflow.io", activeTasks: 5, completedTasks: 48, workload: 51, presence: "away" },
  ...
  { id: "u5", name: "Rahul", role: "Backend Engineer", initials: "R", color: "var(--warning)", email: "rahul@nexusflow.io", activeTasks: 9, completedTasks: 55, workload: 84, presence: "offline" },
...
export const activity = [
  ...
  { id: "a6", who: "Arjun", what: "generated AI insights for", target: "Nexus AI Dashboard", time: "6h" },
